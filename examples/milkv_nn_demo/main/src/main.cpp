...
int _main(int argc, char* argv[])
{
    ...
    while (!app::need_exit()) {
        ...
        printf("<<< got image2, size = %dx%d\n", bg2.stVFrame.u32Width, bg2.stVFrame.u32Height);

#ifdef ENABLE_TDL
        {
        cvtdl_object_t obj_meta = {0};
        CVI_TDL_Detection(tdl_handle, &bg2, enOdModelId, &obj_meta);
