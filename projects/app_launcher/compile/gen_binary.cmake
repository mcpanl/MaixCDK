...
set(cp_dist_cmd2 COMMAND mkdir -p ${PROJECT_DIST_DIR}/${PROJECT_ID}_${build_type} && cp ${CMAKE_BINARY_DIR}/launcher_daemon ${PROJECT_DIST_DIR}/${PROJECT_ID}_${build_type}/)
if(g_dynamic_libs)
