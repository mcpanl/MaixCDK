...
static const std::map<string, string> locale_zh_dict = {
    ...
    {"Scan", "扫描"},
    {"Connect", "连接"},
    {"Runtime not installed", "运行库未安装"},
    {"Runtime need upgrade", "请更新运行库"},
    {"runtime_hint", "请在 '设置' -> 'WiFi' 和 '安装运行库' 联网并安装运行库"},
    {"runtime_hint2", "请在 '设置' -> '安装运行库' 联网并更新运行库"},
    {"Poweroff", "关机"},
    {"Reboot", "重启"},
    {"Poweroff Now", "关机中"},
    {"Reboot Now", "重启中"}
...
static const std::map<string, string> locale_en_dict = {
    {"℃", " Centigrade"},
    {"runtime_hint", "Please connect WiFi and install runtime in 'Settings' -> 'WiFi' and 'Install Runtime'"},
    {"runtime_hint2", "Please upgrade runtime in 'Settings' -> 'Install Runtime'"}
};
