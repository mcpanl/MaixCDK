...
class DeletePopup:
    ...
    def __init__(self, disp):
        self.disp = disp
        self.cancel_btn_img = image.load("./images/cancel_btn.png", image.Format.FMT_RGBA8888)
        self.confirm_btn_img = image.load("./images/confirm_btn.png", image.Format.FMT_RGBA8888)
        self.close_btn_img = image.load("./images/close_btn.png", image.Format.FMT_RGBA8888)
