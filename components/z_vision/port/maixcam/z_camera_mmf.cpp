...
//        mmf_deinit_v2(false);
    ...
    {
        // TODO: add channel
        err::check_bool_raise(false, "add_channel not support");
//        err::check_bool_raise(_check_format(format), "Format not support");
...
//        return img;
    ...
    {
        log::warn("set_resolution not support");
//        if (0 != mmf_del_vi_channel(this->_ch)) {
//            log::error("mmf del vi channel failed");
//        }
//
...
//        return out;
    ...
    int Camera::constrast(int value) {
        log::warn("constrast not support");
...
//        return out;
    ...
    int Camera::saturation(int value) {
        log::warn("saturation not support");
        return value;
