...
#include "maix_fs.hpp"
#include "z_image_def.hpp"
#include "z_image_color.hpp"
#include "z_image_obj.hpp"
...
/**
 * @brief z.image module, image related definition and functions
 * @maixpy z.image
 */
namespace z::image
{
     ...
     * @param fit resize method, see z.image.Fit
    ...
    */
    ...
    public:
         ...
         * @maixpy z.image.Image.__init__
         * @maixcdk z.image.Image.Image
         */
         ...
         * @maixpy z.image.Image.data_size
         */
        int data_size() { return _data_size; }

        /**
         * Get image's width
         * @maixpy z.image.Image.width
         */
        int width() { return _width; }

        /**
         * Get image's height
         * @maixpy z.image.Image.height
         */
         ...
         * @maixcdk z.image.Image.data
         */
        void *data(){ return _data; }

        /**
         * To string method
         * @maixpy z.image.Image.__str__
         */
        std::string __str__();

        /**
         * To string method
         * @maixpy z.image.Image.to_str
         */
         ...
         *
         * @maixpy z.image.Image.get_pixel
        */
         ...
         * @maixpy z.image.Image.set_pixel
        */
         ...
         * @maixpy z.image.Image.to_tensor
         */
         ...
         * @maixpy z.image.Image.to_format
         */
         ...
         * @return new image object. Need be delete by caller in C++.
         * @throw err.Exception, if two images' format not support, **or already the format**, will raise exception
         * @maixcdk z.image.Image.to_format
         */
        ...
        */
         ...
         * @maixpy z.image.Image.draw_image
         */
         ...
         * @return this image object self
         * @maixpy z.image.Image.draw_rect
         */
         ...
         * @return this image object self
         * @maixpy z.image.Image.draw_line
         */
         ...
         * @return this image object self
         * @maixpy z.image.Image.draw_circle
         */
         ...
         * @return this image object self
         * @maixpy z.image.Image.draw_ellipse
         */
         ...
         * @return this image object self
         * @maixpy z.image.Image.draw_string
         */
         ...
         * @maixpy z.image.Image.draw_cross
         */
         ...
         * @param thickness cross thickness(line width), by default(value is 1)
         * @return this image object self
         * @maixpy z.image.Image.draw_arrow
         */
         ...
         * @return this image object self
         * @maixpy z.image.Image.draw_edges
        */
         ...
         * @return this image object self
         * @maixpy z.image.Image.draw_keypoints
        */
         ...
         * @param method resize method, by default is bilinear
         * @return new transformed image object
         * @maixpy z.image.Image.perspective
         */
       ...
       image::Image *flip(const image::FlipDir dir);
         ...
         * @maixpy z.image.Image.mean_pool
        */
         ...
         * @return Returns the image after the operation is completed.
         * @maixpy z.image.Image.midpoint_pool
        */
        ...
        */
         ...
         * @return Returns the image after the operation is completed.
         * @maixpy z.image.Image.mask_rectange
        */
         ...
         * @return Returns the image after the operation is completed.
         * @maixpy z.image.Image.mask_circle
        */
         ...
         * @return Returns the image after the operation is completed.
         * @maixpy z.image.Image.mask_ellipse
        */
        ...
        */
         ...
         * @param brightness The brightness value greater than 0.0 makes the image brighter in a constant manner while less than 0.0 makes the image darker. default is 0.0.
         * @return Returns the image after the operation is completed.
         * @maixpy z.image.Image.gamma_corr
        */
        ...
        */
         ...
         * Only pixels set in the mask are modified. default is None.
         * @return Returns the image after the operation is completed.
         * @maixpy z.image.Image.difference
        */
        ...
        */
         ...
         * Only pixels set in the mask are modified. default is None.
         * @return Returns the image after the operation is completed.
         * @maixpy z.image.Image.laplacian
        */
         ...
         * Only pixels set in the mask are modified. default is None.
         * @return Returns the image after the operation is completed.
         * @maixpy z.image.Image.bilateral
        */
        ...
        */
         ...
         * @return Returns the image after the operation is completed.
         * @maixpy z.image.Image.lens_corr
        */
         ...
         * @return Returns the image after the operation is completed.
         * @maixpy z.image.Image.rotation_corr
        */
         ...
         * @maixpy z.image.Image.get_histogram
        */
         ...
         * @maixpy z.image.Image.get_statistics
        */
         ...
         * @maixpy z.image.Image.get_regression
        */
         ...
         * @return Returns the image after the operation is completed.
         * @maixpy z.image.Image.flood_fill
        */
        ...
        */
         ...
         * Only pixels set in the mask are modified. default is None.
         * @return Returns the image after the operation is completed.
         * @maixpy z.image.Image.black_hat
        */
         ...
         * @maixpy z.image.Image.find_blobs
         */
         ...
         * @maixpy z.image.Image.find_lines
         */
         ...
         * @return Return the line when found lines, format is (line1, line2, ...), you can use line class methods to do more operations
         * @maixpy z.image.Image.find_line_segments
        */
         ...
         * @maixpy z.image.Image.search_line_path
         */
         ...
         * @maixpy z.image.Image.find_circles
         */
         ...
         * @maixpy z.image.Image.find_rects
        */
         ...
         * @maixpy z.image.Image.find_qrcodes
        */
         ...
         * @maixpy z.image.Image.find_apriltags
        */
         ...
         * @maixpy z.image.Image.find_datamatrices
        */
         ...
         * @maixpy z.image.Image.find_barcodes
        */
         ...
         * @maixpy z.image.Image.find_displacement
        */
         ...
         * @maixpy z.image.Image.find_template
        */
         ...
         * @maixpy z.image.Image.find_features
        */
        ...
        */
         ...
         * @maixpy z.image.Image.find_keypoints
        */
         ...
         * @maixpy z.image.Image.find_edges
        */
        ...
        */
         ...
         * @maixpy z.image.Image.match_lbp_descriptor
        */
         ...
         * @return Returns the match of the image
         * @maixpy z.image.Image.match_orb_descriptor
        */
         ...
         * @param h original rectagle height, can be -1 if not use this arg, default -1.
         * @return list type, [x, y] if map point, [x, y, w, h] if resize rectangle.
         * @maixpy z.image.Image.resize_map_pos
        */
    ...
    */
     ...
     * @return error code, err::ERR_NONE is ok, other is error
     * @maixpy z.image.set_default_font
     */
