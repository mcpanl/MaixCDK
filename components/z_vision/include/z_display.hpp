...
/**
 * @brief z.display module, control display device and show image on it
 * @maixpy z.display
*/
namespace z::display
{
    ...
    public:
         ...
         * @maixpy z.display.Display.__init__
         * @maixcdk z.display.Display.Display
         */
         ...
         * Get display width
         * @return width
         * @maixpy z.display.Display.width
        */
        int width();
         ...
         * @return height
         * @maixpy z.display.Display.height
        */
        int height();
        ...
        */
         ...
         * Get display format
         * @return format
         * @maixpy z.display.Display.format
        */
        image::Format format();
        ...
        */
         ...
         * @return error code
         * @maixpy z.display.Display.close
        */
        err::Err close();
         ...
         * @maixpy z.display.Display.add_channel
        */
         ...
         * @maixpy z.display.Display.is_opened
        */
        bool is_opened();
         ...
         * @maixpy z.display.Display.is_closed
        */
        ...
        */
         ...
         * @maixpy z.display.Display.device
        */
        std::string device()
        {
            return _device;
         ...
         * @maixpy z.display.Display.set_backlight
        */
         ...
         * @maixpy z.display.Display.get_backlight
        */
        float get_backlight();
         ...
         * @maixpy z.display.Display.set_hmirror
        */
         ...
         * @maixpy z.display.Display.set_vflip
        */
     ...
     * @maixpy z.display.send_to_maixvision
    */
     ...
     * @maixpy z.display.set_trans_image_quality
     */
