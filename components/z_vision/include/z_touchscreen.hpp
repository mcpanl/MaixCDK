...
namespace z::touchscreen
{
    /**
     * TouchScreen class
     * @maixpy z.touchscreen.TouchScreen
     */
    class TouchScreen
    {
    public:
         ...
         * @maixpy z.touchscreen.TouchScreen.__init__
         * @maixcdk z.touchscreen.TouchScreen.TouchScreen
         */
         ...
         * @maixpy z.touchscreen.TouchScreen.open
         */
        err::Err open();
         ...
         * @return error code, err::ERR_NONE means success, others means failed
         * @maixpy z.touchscreen.TouchScreen.close
         */
        err::Err close();
         ...
         * @maixcdk z.touchscreen.TouchScreen.read
         */
         ...
         * @maixpy z.touchscreen.TouchScreen.read
         */
        std::vector<int> read();
         ...
         * @param pressed pressed state
         * @return error code, err::ERR_NONE means success, others means failed, if no event return err::ERR_NOT_READY
         * @maixcdk z.touchscreen.TouchScreen.read0
         */
         ...
         *            or too much event in buffer when your program call this read() interval is too long will make your program slow.
         * @return Returns a list include x, y, pressed state
         * @maixpy z.touchscreen.TouchScreen.read0
         */
         ...
         * @maixpy z.touchscreen.TouchScreen.available
        */
         ...
         * @maixpy z.touchscreen.TouchScreen.is_opened
        */
        bool is_opened();
    private:
