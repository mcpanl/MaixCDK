...
namespace z::image
{
    ...
    */
    ...
    public:
        ...
        /**
         * Color red channel
         * @maixpy z.image.Color.r
        */
        uint8_t r;

        /**
         * Color green channel
         * @maixpy z.image.Color.g
        */
        uint8_t g;

        /**
         * Color blue channel
         * @maixpy z.image.Color.b
        */
        uint8_t b;

        /**
         * Color alpha channel, value from 0.0 to 1.0, float value
         * @maixpy z.image.Color.alpha
        */
        float alpha;

        /**
         * Color gray channel
         * @maixpy z.image.Color.gray
        */
        uint8_t gray;

        /**
         * Color format
         * @maixpy z.image.Color.format
        */
        image::Format format;

        /**
         * Get color's hex value
         * @maixpy z.image.Color.hex
        */
        uint32_t hex()
        {
            uint32_t hex = 0;
        ...
        */
         ...
         * @maixpy z.image.Color.from_gray
        */
         ...
         * @maixpy z.image.Color.from_rgba
        */
         ...
         * * @param alpha alpha channel, float value, value range: 0 ~ 1
         * @maixpy z.image.Color.from_bgra
        */
        ...
        */
         ...
         * @maixpy z.image.Color.to_format
        */
         ...
         * @maixpy z.image.Color.to_format2
        */
