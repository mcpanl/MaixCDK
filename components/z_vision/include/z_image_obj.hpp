...
namespace z::image
{
    ...
    public:
         ...
         * @return int&
         * @maixpy z.image.Line.__getitem__
         */
    ...
    */
    ...
    public:
        ...
        */
         ...
         * @return int&
         * @maixpy z.image.Rect.__getitem__
         */
        int &__getitem__(int index)
        {
            switch (index) {
    ...
    public:
         ...
         * @maixpy z.image.Circle.__init__
         */
         ...
         * @return int&
         * @maixpy z.image.Circle.__getitem__
         */
        int &__getitem__(int index)
        {
            switch (index) {
         ...
         * @return return magnitude, type is int
         * @maixpy z.image.Circle.magnitude
         */
        int magnitude()
        {
            return _magnitude;
    ...
    public:
         ...
         * @maixpy z.image.Blob.__getitem__
         */
        int &__getitem__(int index)
        {
        switch (index) {
         ...
         *   (x3, y3)           (x2, y2)
         * note: the order of corners may change
         * @maixpy z.image.Blob.mini_corners
         */
         ...
         * @maixpy z.image.Blob.rotation_rad
         */
        float rotation_rad()
        {
            return _rotation_f;
         ...
         * @maixpy z.image.Blob.rotation_deg
         */
        int rotation_deg()
        {
         ...
         * @maixpy z.image.Blob.elongation
         */
        float elongation() {
            return 1 - _roundness;
        }
         ...
         * @maixpy z.image.Blob.compactness
         */
        float compactness() {
         ...
         * @maixpy z.image.Blob.x_hist_bins
         */
         ...
         * @maixpy z.image.Blob.y_hist_bins
         */
         ...
         * @maixpy z.image.Blob.major_axis_line
         */
         ...
         * @return Returns a line tuple (x1, y1, x2, y2) of the minor axis of the blob.
         * @maixpy z.image.Blob.minor_axis_line
         */
         ...
         * @maixpy z.image.Blob.enclosing_circle
         */
         ...
         * @maixpy z.image.Blob.enclosed_ellipse
         */
     ...
     * @maixpy z.image.QRCodeDecoderType
    */
    ...
    public:
         ...
         * @maixpy z.image.QRCode.__init__
         */
         ...
         * @return int&
         * @maixpy z.image.QRCode.__getitem__
         */
        int &__getitem__(int index)
        {
            switch (index) {
         ...
         * @maixpy z.image.QRCode.ecc_level
         */
        int ecc_level() {
            return _ecc_level;
        }
         ...
         * @return return mask of the QRCode
         * @maixpy z.image.QRCode.data_type
         */
        int data_type() {
            return _data_type;
        }
         ...
         * @maixpy z.image.QRCode.is_numeric
         */
        bool is_numeric() {
            return _data_type == 1;
        }
         ...
         * @maixpy z.image.QRCode.is_alphanumeric
         */
         ...
         * @maixpy z.image.QRCode.is_binary
         */
        bool is_binary() {
            return _data_type == 4;
        }
         ...
         * @maixpy z.image.QRCode.is_kanji
         */
        bool is_kanji() {
            return _data_type == 8;
        }
    ...
    public:
         ...
         * @maixpy z.image.AprilTag.__init__
        */
         ...
         * [17] Not support
         * @return int&
         * @maixpy z.image.AprilTag.__getitem__
         */
        int &__getitem__(int index)
        {
            switch (index) {
         ...
         * @maixpy z.image.AprilTag.corners
         */
        std::vector<std::vector<int>> corners() {
            return _corners;
        }
         ...
         * @maixpy z.image.AprilTag.family
         */
        int family()  {
            return _family;
        }
        ...
        */
         ...
         * @maixpy z.image.AprilTag.rotation
        */
        float rotation() {
            return _rotation;
        }
         ...
         * @maixpy z.image.AprilTag.decision_margin
        */
         ...
         * @maixpy z.image.AprilTag.hamming
         */
        int hamming() {
            return _hamming;
        }
         ...
         * @maixpy z.image.AprilTag.goodness
         */
        float goodness() {
            return _goodness;
        }
         ...
         * @maixpy z.image.AprilTag.x_translation
         */
        float x_translation() {
         ...
         * @maixpy z.image.AprilTag.y_translation
         */
        float y_translation() {
         ...
         * @maixpy z.image.AprilTag.z_translation
         */
        float z_translation() {
         ...
         * @maixpy z.image.AprilTag.x_rotation
         */
        float x_rotation() {
            return _x_rotation;
        }
         ...
         * @maixpy z.image.AprilTag.y_rotation
         */
        float y_rotation() {
            return _y_rotation;
        }
         ...
         * @maixpy z.image.AprilTag.z_rotation
         */
        float z_rotation() {
            return _z_rotation;
        }
    ...
    public:
         ...
         * @maixpy z.image.DataMatrix.__init__
        */
         ...
         * @return int&
         * @maixpy z.image.DataMatrix.__getitem__
         */
        int &__getitem__(int index)
        {
            switch (index) {
         ...
         * @maixpy z.image.DataMatrix.corners
         */
        std::vector<std::vector<int>> corners() {
            return _corners;
        }
         ...
         * @maixpy z.image.DataMatrix.rect
         */
        std::vector<int> rect() {
            return {_x, _y, _w, _h};
        }
         ...
         * @maixpy z.image.DataMatrix.payload
         */
        std::string payload() {
            return _payload;
        }
         ...
         * @maixpy z.image.DataMatrix.rotation
         */
        float rotation() {
            return _rotation;
        }
         ...
         * @maixpy z.image.DataMatrix.rows
         */
        int rows() {
            return _rows;
        }
         ...
         * @maixpy z.image.DataMatrix.columns
         */
        int columns() {
            return _columns;
        }
         ...
         * @maixpy z.image.DataMatrix.capacity
         */
        int capacity() {
            return _capacity;
        }
         ...
         * @maixpy z.image.DataMatrix.padding
         */
        int padding() {
            return _padding;
        }
    ...
    public:
         ...
         * @maixpy z.image.BarCode.__init__
        */
         ...
         * @return int&
         * @maixpy z.image.BarCode.__getitem__
         */
        int &__getitem__(int index)
        {
            switch (index) {
         ...
         * @maixpy z.image.BarCode.corners
         */
        std::vector<std::vector<int>> corners() {
            return _corners;
        }
         ...
         * @maixpy z.image.BarCode.payload
         */
        std::string payload() {
            return _payload;
        }
         ...
         * @maixpy z.image.BarCode.rotation
         */
        float rotation() {
            return _rotation;
        }
         ...
         * @maixpy z.image.BarCode.quality
         */
        int quality() {
            return _quality;
        }
    ...
    public:
         ...
         * @maixpy z.image.Statistics.__init__
        */
         ...
         * @return int&
         * @maixpy z.image.Statistics.__getitem__
         */
        int &__getitem__(int index)
        {
            switch (index) {
         ...
         * @maixpy z.image.Statistics.format
         */
        image::Format format() {
            return _format;
        }
         ...
         * @maixpy z.image.Statistics.l_mean
         */
        int l_mean() {
            return _l_mean;
        }
         ...
         * @maixpy z.image.Statistics.l_median
         */
        int l_median() {
            return _l_median;
        }
         ...
         * @maixpy z.image.Statistics.l_mode
         */
        int l_mode() {
            return _l_mode;
        }
         ...
         * @maixpy z.image.Statistics.l_std_dev
         */
        int l_std_dev() {
            return _l_std_dev;
        }
         ...
         * @maixpy z.image.Statistics.l_min
         */
        int l_min() {
            return _l_min;
        }
         ...
         * @maixpy z.image.Statistics.l_max
         */
        int l_max() {
            return _l_max;
        }
         ...
         * @maixpy z.image.Statistics.l_lq
         */
        int l_lq() {
            return _l_lq;
        }
         ...
         * @maixpy z.image.Statistics.l_uq
         */
        int l_uq() {
            return _l_uq;
        }
         ...
         * @maixpy z.image.Statistics.a_mean
         */
        int a_mean() {
            return _a_mean;
        }
         ...
         * @maixpy z.image.Statistics.a_median
         */
        int a_median() {
            return _a_median;
        }
         ...
         * @maixpy z.image.Statistics.a_mode
         */
        int a_mode() {
            return _a_mode;
        }
         ...
         * @maixpy z.image.Statistics.a_std_dev
         */
        int a_std_dev() {
            return _a_std_dev;
        }
         ...
         * @maixpy z.image.Statistics.a_min
         */
        int a_min() {
            return _a_min;
        }
         ...
         * @maixpy z.image.Statistics.a_max
         */
        int a_max() {
            return _a_max;
        }
         ...
         * @maixpy z.image.Statistics.a_lq
         */
        int a_lq() {
            return _a_lq;
        }
         ...
         * @maixpy z.image.Statistics.a_uq
         */
        int a_uq() {
            return _a_uq;
        }
         ...
         * @maixpy z.image.Statistics.b_mean
         */
        int b_mean() {
            return _b_mean;
        }
         ...
         * @maixpy z.image.Statistics.b_median
         */
        int b_median() {
            return _b_median;
        }
         ...
         * @maixpy z.image.Statistics.b_mode
         */
        int b_mode() {
            return _b_mode;
        }
         ...
         * @maixpy z.image.Statistics.b_std_dev
         */
        int b_std_dev() {
            return _b_std_dev;
        }
         ...
         * @maixpy z.image.Statistics.b_min
         */
        int b_min() {
            return _b_min;
        }
         ...
         * @maixpy z.image.Statistics.b_max
         */
        int b_max() {
            return _b_max;
        }
         ...
         * @maixpy z.image.Statistics.b_lq
         */
        int b_lq() {
            return _b_lq;
        }
         ...
         * @maixpy z.image.Statistics.b_uq
         */
        int b_uq() {
            return _b_uq;
        }
    ...
    public:
         ...
         * @maixpy z.image.Displacement.__init__
        */
         ...
         * @param index array index
         * @return int&
         * @maixpy z.image.Displacement.__getitem__
         */
        int &__getitem__(int index)
        {
            switch (index) {
         ...
         * @maixpy z.image.Displacement.x_translation
         */
        float x_translation() {
            return _x_translation;
        }
         ...
         * @maixpy z.image.Displacement.y_translation
         */
        float y_translation() {
            return _y_translation;
        }
         ...
         * @maixpy z.image.Displacement.rotation
         */
        float rotation() {
            return _rotation;
        }
         ...
         * @maixpy z.image.Displacement.scale
         */
        float scale() {
            return _scale;
        }
         ...
         * @maixpy z.image.Displacement.response
         */
        float response() {
            return _response;
        }
    ...
    public:
         ...
         * @maixpy z.image.Percentile.__init__
        */
         ...
         * @maixpy z.image.Percentile.__getitem__
         */
        int &__getitem__(int index)
        {
            switch (index) {
         ...
         * @maixpy z.image.Percentile.value
        */
        int value() {
         ...
         * @maixpy z.image.Percentile.l_value
        */
        int l_value() {
            return this->_l_value;
        }
         ...
         * @maixpy z.image.Percentile.a_value
        */
        int a_value() {
         ...
         * @maixpy z.image.Percentile.b_value
        */
        int b_value() {
    ...
    public:
         ...
         * @maixpy z.image.Threshold.__init__
        */
        ...
        /**
         * @brief Subscript operator
         * @maixpy z.image.Threshold.__getitem__
         */
        int &__getitem__(int index)
        {
            switch (index) {
         ...
         * @maixpy z.image.Threshold.value
        */
        int value() {
            return this->_l_value;
        }
         ...
         * @return returns l channel percentile value
         * @maixpy z.image.Threshold.l_value
        */
        int l_value() {
            return this->_l_value;
        }
         ...
         * @return returns a channel percentile value
         * @maixpy z.image.Threshold.a_value
        */
        int a_value() {
            return this->_a_value;
        }
         ...
         * @return returns b channel percentile value
         * @maixpy z.image.Threshold.b_value
        */
        int b_value() {
            return this->_b_value;
        }
    ...
    public:
         ...
         * @maixpy z.image.Histogram.__init__
        */
        ...
        /**
         * @brief Subscript operator
         * @maixpy z.image.Histogram.__getitem__
         */
        int &__getitem__(int index)
        {
            switch (index) {
        ...
        */
         ...
         * @maixpy z.image.Histogram.l_bins
        */
         ...
         * @maixpy z.image.Histogram.a_bins
        */
         ...
         * @maixpy z.image.Histogram.b_bins
        */
         ...
         * @maixpy z.image.Histogram.get_percentile
        */
         ...
         * @maixpy z.image.Histogram.get_threshold
        */
         ...
         * @maixpy z.image.Histogram.get_statistics
        */
    ...
    public:
         ...
         * @maixpy z.image.LBPKeyPoint.__init__
        */
    ...
    public:
         ...
         * @maixpy z.image.KeyPoint.__init__
        */
    ...
    public:
         ...
         * @maixpy z.image.KPTMatch.__init__
        */
    ...
    public:
         ...
         * @maixpy z.image.ORBKeyPoint.__init__
        */
         ...
         * @maixpy z.image.ORBKeyPoint.get_data
         */
    ...
    public:
         ...
         * @maixpy z.image.HaarCascade.__init__
        */
        HaarCascade()
        {
    ...
    */
    ...
    public:
         ...
         * @maixpy z.image.LineGroup.__init__
        */
        ...
        */
         ...
         * @maixpy z.image.LineGroup.lines
        */
