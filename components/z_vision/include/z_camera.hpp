...
/**
 * @brief z.camera module, access camera device and get image from it
 * @maixpy z.camera
*/
namespace z::camera
{
    ...
    */
    ...
    public:
         ...
         * @maixpy z.camera.Camera.__init__
         * @maixcdk z.camera.Camera.Camera
         */
         ...
         * @maixpy z.camera.Camera.get_ch_nums
         */
        int get_ch_nums();
        ...
        */
         ...
         * @maixpy z.camera.Camera.skip_frames
        */
        void skip_frames(int num);

        /**
         * Close camera
         * @maixpy z.camera.Camera.close
        */
        void close();
         ...
         * @maixpy z.camera.Camera.add_channel
        */
         ...
         * @maixpy z.camera.Camera.is_opened
        */
        bool is_opened();
         ...
         * @maixpy z.camera.Camera.is_closed
        */
        ...
        */
         ...
         * @maixpy z.camera.Camera.buff_num
        */
        int buff_num()
        {
            return _buff_num;
         ...
         * @maixpy z.camera.Camera.hmirror
         */
        ...
        */
         ...
         * @return error code, err::ERR_NONE means success, others means failed
         * @maixpy z.camera.Camera.write_reg
         */
         ...
         * @param bit_width register data bit width, default is 8
         * @maixpy z.camera.Camera.read_reg
         */
         ...
         * @return error code, err::ERR_NONE means success, others means failed
         * @maixpy z.camera.Camera.show_colorbar
         */
         ...
         * @maixpy z.camera.Camera.get_channel
         */
        int get_channel();
         ...
         * @return error code, err::ERR_NONE means success, others means failed
         * @maixpy z.camera.Camera.set_resolution
        */
         ...
         * @param fps new fps
         * @return error code, err::ERR_NONE means success, others means failed
         * @maixpy z.camera.Camera.set_fps
        */
         ...
         * @maixpy z.camera.Camera.exposure
        */
        ...
        */
         ...
         * @maixpy z.camera.Camera.constrast
        */
         ...
         * @maixpy z.camera.Camera.saturation
        */
         ...
         * @maixpy z.camera.Camera.awb_mode
        */
         ...
         * @return returns awb mode
         * @maixpy z.camera.Camera.set_awb
        */
         ...
         * @maixpy z.camera.Camera.exp_mode
        */
         ...
         * @return error code
         * @maixpy z.camera.Camera.set_windowing
        */
