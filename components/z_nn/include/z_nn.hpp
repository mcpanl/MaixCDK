...
namespace z::nn
{
    ...
    public:
         ...
         * @maixpy z.nn.MUD.__init__
         * @maixcdk z.nn.MUD.MUD
         */
    ...
    */
    ...
    public:
         ...
         * @maixpy z.nn.LayerInfo.__init__
         * @maixcdk z.nn.LayerInfo.LayerInfo
         */
         ...
         * @maixpy z.nn.LayerInfo.dtype
         */
        tensor::DType dtype;

        /**
         * Layer shape
         * @maixpy z.nn.LayerInfo.shape
         */
        std::vector<int> shape;

        /**
         * Shape as one int type, multiply all dims of shape
         * @maixpy z.nn.LayerInfo.shape_int
         */
        int shape_int()
        {
    ...
    public:
         ...
         * @maixpy z.nn.NN.extra_info_labels
         */
         ...
         * @maixcdk z.nn.NN.extra_info_labels
         */
