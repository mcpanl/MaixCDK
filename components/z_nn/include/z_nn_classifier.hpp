...
namespace z::nn
{
    ...
    public:
         ...
         * @maixpy z.nn.Classifier.__init__
         * @maixcdk z.nn.Classifier.Classifier
         */
        ...
        err::Err load(const string &model)
        {
            ...
            if (_extra_info.find("input_type") != _extra_info.end())
            {
                ...
                if (input_type == "rgb")
                {
                    _input_img_fmt = z::image::FMT_RGB888;
                }
                else if (input_type == "bgr")
                {
                    _input_img_fmt = z::image::FMT_BGR888;
                }
                else if (input_type == "gray")
                {
                    _input_img_fmt = z::image::FMT_GRAYSCALE;
                }
                else
                {
         ...
         * @maixpy z.nn.Classifier.classify
         */
         ...
         * @maixpy z.nn.Classifier.classify_raw
         */
         ...
         * @maixpy z.nn.Classifier.input_size
         */
         ...
         * @maixpy z.nn.Classifier.input_width
         */
        int input_width()
        {
         ...
         * @maixpy z.nn.Classifier.input_height
         */
        int input_height()
        {
         ...
         * @maixpy z.nn.Classifier.input_format
         */
         ...
         * @maixpy z.nn.Classifier.input_shape
         */
    ...
    public:
        /**
         * Labels list
         * @maixpy z.nn.Classifier.labels
         */
        std::vector<string> labels;

        /**
         * Label file path
         * @maixpy z.nn.Classifier.label_path
         */
        std::string label_path;

        /**
         * Get mean value, list type
         * @maixpy z.nn.Classifier.mean
         */
        std::vector<float> mean;

        /**
         * Get scale value, list type
         * @maixpy z.nn.Classifier.scale
         */
