...
static struct panel_desc_s g_panel_desc = {
	...
	.stdsicfg.dev_cfg = &dev_cfg_st7701_480x640,
	.stdsicfg.hs_timing_cfg = &hs_timing_cfg_st7701_480x640,
	.stdsicfg.dsi_init_cmds = dsi_init_cmds_st7701_480x640,
	.stdsicfg.dsi_init_cmds_size = ARRAY_SIZE(dsi_init_cmds_st7701_480x640)
};
...
void SAMPLE_SET_PANEL_DESC(void)
{
	...
	case DSI_PANEL_ST7701:
		g_panel_desc.panel_type = PANEL_MODE_DSI;
		g_panel_desc.stdsicfg.dev_cfg = &dev_cfg_st7701_480x640;
